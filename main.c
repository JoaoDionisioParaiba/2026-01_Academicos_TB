...
#include "funcao_multiplicacao.h" // <- TIROU AS BARRAS AQUI!
...
int main() {
    ...
    int resultado_multiplicacao = multiplicar(7, 6); // <- TIROU AS BARRAS AQUI!
    printf("Multiplicacao (7 * 6): %d\n", resultado_multiplicacao); // <- TIROU AS BARRAS AQUI!
